public class MathOperations {
 public static void main(String[] args) {
     ...
     System.out.println("With bonus marks, Ron scored " + (testScore + bounsMarks) + "/10 on his potions test. Snape wasn't too thrilled" );
     ...
     System.out.println("Snape ended up removing marks. Ron actually scored " + (testScore - bounsMarks) + " on his potions test");

     System.out.println("Fred and George used a special spell to multiply their sweets to: " + (bagOfSweets1 * bagOfSweets2));
     System.out.println("Snape made an error on his excel, accidentally multiplying Ron's score to: " + (testScore * bounsMarks) + "/10" );
     ...
     System.out.println("Snape caught the error. Furious, he divided Ron's score to: " + (testScore / bounsMarks));
